...
const User = () => {
  ...
  const logout = <img onClick={signOut} src={session?.user.image} className="h-10 w-10 rounded-full cursor-pointer p-1 hover:shadow-lg shadow-gray-600" alt="user profile"/>;
